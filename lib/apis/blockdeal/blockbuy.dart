...
class BlockBuy extends StatefulWidget {
  const BlockBuy({ Key? key }) : super(key: key);

  @override
  _BlockBuyState createState() => _BlockBuyState();
}

class _BlockBuyState extends State<BlockBuy> {
   List listResponse = [];
    Map mapResponse = {};
