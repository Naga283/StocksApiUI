...
class AllBlockDeal extends StatefulWidget {
  const AllBlockDeal({ Key? key }) : super(key: key);

  @override
  _AllBlockDealState createState() => _AllBlockDealState();
}

class _AllBlockDealState extends State<AllBlockDeal> {
   List listResponse = [];
    Map mapResponse = {};
    Future fetchData() async {
    http.Response response;
    response = await http
        .get(Uri.parse("https://www.goindiastocks.com/api/service/GetBulkBlockDeal?fincode=100114&DealType=Block_Deal"));
