...
class BlockSell extends StatefulWidget {
  const BlockSell({ Key? key }) : super(key: key);

  @override
  _BlockSellState createState() => _BlockSellState();
}

class _BlockSellState extends State<BlockSell> {
   List listResponse = [];
    Map mapResponse = {};
