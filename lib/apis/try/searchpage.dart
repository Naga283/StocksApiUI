...
//   DealModel({required this.text, required this.author});
...
class JobsState extends State<Jobs> {
  ...
  String url = 'https://www.goindiastocks.com/api/service/GetBulkBlockDeal?fincode=100114&DealType=Bulk_Deal';
  ...
  Future<List<Subject>> getAllulistList() async {
    try {
      ...
      if (response.statusCode == 200) {
        // print(response.body);
      Map   maprespone = parseAgents(response.body) as Map;
        // List<Subject> list = parseAgents(response.body);
      List<Subject>  list = maprespone["Data"];
        return list;
      } else {
